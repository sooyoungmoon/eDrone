...
#include "mission_lib_msgs/MissionClear.h"
...
mission_lib_msgs::MissionClear missionClear_cmd;
...
int main(int argc, char** argv)
{
 ...
 ros::ServiceClient missionClear_client =nh.serviceClient<mission_lib_msgs::MissionClear>("srv_missionClear");
