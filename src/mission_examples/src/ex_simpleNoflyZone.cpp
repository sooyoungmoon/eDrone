...
#include "mission_lib_msgs/MissionAddItem.h"
#include "mission_lib_msgs/MissionUpload.h"
#include "mission_lib_msgs/MissionDownload.h"
#include "mission_lib_msgs/Geofence.h"
#include "mission_lib_msgs/NoflyZone.h"
...
mission_lib_msgs::MissionAddItem missionAddItem_cmd;
mission_lib_msgs::MissionUpload missionUpload_cmd;
mission_lib_msgs::MissionDownload missionDownload_cmd;
mission_lib_msgs::Geofence geofence_cmd;
mission_lib_msgs::NoflyZone noflyZone_cmd;
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceClient missionAddItem_client =nh.serviceClient<mission_lib_msgs::MissionAddItem>("srv_missionAddItem");

  ros::ServiceClient geofence_client = nh.serviceClient<mission_lib_msgs::Geofence>("srv_geofence");


  ros::ServiceClient missionUpload_client =nh.serviceClient<mission_lib_msgs::MissionUpload>("srv_missionUpload");

  ros::ServiceClient missionDownload_client =nh.serviceClient<mission_lib_msgs::MissionDownload>("srv_missionDownload");
 
  ros::ServiceClient noflyZone_client = nh.serviceClient<mission_lib_msgs::NoflyZone>("srv_noflyZone");
...
*/
  ...
  ROS_ERROR("missionAddItem command was sent\n");
  ...
  ROS_ERROR("missionUpload command was sent\n");
