...
#include "mission_lib/NoflyZone.h"
...
mission_lib::NoflyZone noflyZone_cmd;

int main(int argc, char** argv)
{
  printf("==ex_wpNoflyZone==\n");
  
  ros::init(argc, argv, "ex_wpNoflyZone");
  ros::NodeHandle nh;
  ...
  ros::ServiceClient noflyZone_client = nh.serviceClient<mission_lib::NoflyZone>("srv_noflyZone");
