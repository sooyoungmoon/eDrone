...
#include "mission_lib/ModeChange.h" // 비행 모드 변경 서비스 헤더 파일
...
bool srv_modeChange_cb(mission_lib::ModeChange &req, mission_lib::ModeChange &res)
{

	return true;
}

bool srv_rtl_cb(mission_lib::RTL &req, mission_lib::RTL &res)
{
	return true;
}
