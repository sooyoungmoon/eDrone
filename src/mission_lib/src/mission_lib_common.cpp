...
#include "mission_lib_msgs/CheckState.h" // 무인기 상태 확인 서비스
#include "mission_lib_msgs/CheckPosition.h" // 무인기 위치 확인 서비스
#include "mission_lib_msgs/CheckHome.h" // home 위치 확인 서비스
...
bool srv_takeoff_cb(mission_lib_msgs::Takeoff::Request &req, mission_lib_msgs::Takeoff::Response &res)
{
...
bool srv_landing_cb(mission_lib_msgs::Landing::Request &req, mission_lib_msgs::Landing::Response &res)
{
...
bool srv_chkState_cb(mission_lib_msgs::CheckState::Request &req, mission_lib_msgs::CheckState::Response &res)
{
...
bool srv_chkPosition_cb(mission_lib_msgs::CheckPosition::Request &req, mission_lib_msgs::CheckPosition::Response &res)
{
	GeoInfo& geoInfo = GeoInfo::getInstance();
...
bool srv_chkHome_cb(mission_lib_msgs::CheckHome::Request& req, mission_lib_msgs::CheckHome::Response& res)
{
	GeoInfo& geoInfo = GeoInfo::getInstance();
...

{
	...
	ros::init(argc, argv, "mission_lib_common");
 	ros::NodeHandle nh; 
